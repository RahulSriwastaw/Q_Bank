  ...
  return (
    <div className="bg-[#1e1e1e] border border-white/10 p-4 rounded-xl shadow-2xl mb-2 w-80 animate-in slide-in-from-bottom-2 fade-in duration-200 pointer-events-auto max-h-[60vh] overflow-y-auto custom-scrollbar">
      <div className="space-y-6">
        ...
        {/* Card Styling */}
        <div className="space-y-3">
            <div className="text-[10px] font-bold text-slate-500 uppercase tracking-widest border-b border-white/5 pb-1">Question Card</div>
        ...
        <div className="pt-2 border-t border-white/10">
            <button 
                onClick={() => setQuestionStyle({ position: { x: 0, y: 0 } })}
                className="w-full py-2 text-xs font-bold text-slate-400 hover:text-white hover:bg-white/5 rounded-lg flex items-center justify-center gap-2 transition-colors"
            >
                <Move size={14} /> Reset Position
            </button>
        </div>
