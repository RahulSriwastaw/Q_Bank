...
export const LaserToolbar: React.FC<LaserToolbarProps> = ({ onClose }) => {
  ...
  return (
    <div className="bg-[#1e1e1e] border border-white/10 p-4 rounded-xl shadow-2xl mb-2 w-80 max-w-[90vw] animate-in slide-in-from-bottom-2 fade-in duration-200 pointer-events-auto">
      {/* Header */}
