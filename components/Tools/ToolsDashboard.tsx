...
import { Sparkles, FileText, ArrowLeft, Wrench, ChevronRight } from 'lucide-react';
...
export const ToolsDashboard: React.FC<ToolsDashboardProps> = ({ onExit }) => {
    const [currentTool, setCurrentTool] = useState<'dashboard' | 'proofreader' | 'pdf2text'>('dashboard');
