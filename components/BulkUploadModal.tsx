...
export const BulkUploadModal: React.FC<BulkUploadModalProps> = ({ onClose, onSuccess }) => {
    ...
    const renderUploadStep = () => (
        <div
            className="group relative border-2 border-dashed border-slate-200 rounded-[40px] p-20 text-center hover:border-primary hover:bg-primary/5 transition-all cursor-pointer overflow-hidden animate-in fade-in zoom-in-95 duration-500"
            ...
            <div className="relative z-10">
                ...
                <div className="mt-12 flex justify-center gap-6">
                    <div className="flex items-center gap-2 text-[10px] font-black uppercase text-slate-400">
                        <div className="w-1.5 h-1.5 rounded-full bg-success" /> Validated Format
                    </div>
                </div>
            </div>
        </div>
